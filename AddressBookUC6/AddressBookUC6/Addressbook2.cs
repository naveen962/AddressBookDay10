...
namespace AddressBookUC6
{
    class Addressbook2
    {
        ...
        {
            foreach (KeyValuePair<string, Contact> kvp in addressbook2)
            {
        ...
        void DeleteContact()
        {
            ...
            addressbook2.Remove(key);
            if (!addressbook2.ContainsKey(key))
            {
        ...
        public void getaddressbook2()
        {
            while (true)
            {
                ...
                int choice = int.Parse(Console.ReadLine());
                Addressbook2 p = new Addressbook2();
                if (choice == 1)
                {
    ...
    class Contact1
    {
        ...
        public Contact1(string fn, string ln, string city, string state, string email, long phno, int zip)
        {
            Firstname = fn;
            Lastname = ln;
            City = city;
