...
namespace AddressBookUC3
{
    class Program
    {
        ...
        /// The addressbook
        /// </summary>
        static public Dictionary<string, Contact> addressbook = new Dictionary<string, Contact>();
        ...
        static void Main(string[] args)
        {
            while (true)
            {
                Console.WriteLine("Enter your choice :1->AddRecord 2->UpdateContact 3->exit ");
                int choice = int.Parse(Console.ReadLine());
